...
async def get_contacts():
    ...
    # بدلاً من get_contacts، استخدم get_participants
    contacts = await client.get_participants('me')  # استخراج جهات الاتصال
    ...
    with open('contacts.csv', mode='w', newline='', encoding='utf-8') as file:
        ...
        for contact in contacts:
            writer.writerow([contact.username, contact.phone])
